...
권세한_벌금 = sum([6_000,9_000,3_000,7_000])
권하은_벌금 = sum([9_000,53_000])
박지은_벌금 = sum([21_000,9_000,6_000,4_000,18_000,6000])
박하은_벌금 = sum([9_000,12_000,10_000, 3_000,8_000])
손하진_벌금 = sum([56_000])
송호석_벌금 = sum([33_000])
이신후_벌금 = sum([3_000,31_000,14_000])
이준수_벌금 = sum([21_000])
